within Brine;
partial package PartialBrine
  "Template package for liquid aqueous NaCl-Solution without property functions "
...
*/
 ...
 //  T = temperature_phX(p,h,X);
   u = 1 "h - p/d";
   MM = X[1]*PartialBrine.Salt_data.M_NaCl + X[2]*PartialBrine.M_H2O;
   R  = 8.3144/MM;
