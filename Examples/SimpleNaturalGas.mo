...
*/
  ...
  Modelica.SIunits.Density d_g1= medium2.d;
  Modelica.SIunits.Density d_g2 = medium2.p/(Modelica.Constants.R*medium2.T)*(n_g*MM_gas)/sum(n_g)
    "From PartialBrine_ngas_Newton.setState_pTX()";
  Modelica.SIunits.Density d_g3 = medium2.p/(medium2.T*R);
