...
//  Modelica.SIunits.SpecificEnthalpy[:] h_salt_100(start={300500,0,0,0,0});
  Modelica.SIunits.SpecificEnthalpy h_Driesner= Brine.SpecificEnthalpies.specificEnthalpy_pTX_Driesner(props.p,props.T,sum(props.X[1:5]));
...
//   props.Xi = f*{0.089182812,0.005197713,0.137651853,0.001453699,0.002621355,1.6015e-4,8.07e-4,7.209e-5}     "Entsprechend STR04/16 bei GG mit d_l=1091.37 kg/m³ - X_g stimmt";
   props.Xi = 0*{    0.081109,   0.0047275,     0.12519,   0*0.0013225,  0*0.0023842,  0.00016889,  0.00073464, 6.5657e-005}
