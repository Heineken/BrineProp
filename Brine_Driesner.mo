within Brine;
package Brine_Driesner
  "NaCl solution using Driesner density and enthalpy function"
  extends PartialBrine;
...
*/
  ...
  algorithm
    h := Brine.SpecificEnthalpies.specificEnthalpy_pTX_Driesner(p,T,X);
